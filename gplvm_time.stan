...
model {
    ...
    //prior on X
    {
        ...
        // kernel_f_time(vector[] X1, vector[] X2, real l, real sigma, real jitter, int kernel_n)
...
generated quantities {
    ...
    // for (d in 1:D){
    //     log_likelihood = log_likelihood + multi_normal_cholesky_lpdf(col(Y,d) | zeros_N, L_y[d]);}
// }
